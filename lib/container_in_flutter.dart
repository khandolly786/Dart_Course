// container are used to store in one box, it has only one child
// it is by default invisible
// it is a widget that combines common painting, positioning, and sizing operations into one widget.
